...
wgtdat <- data.frame(
  date = ymd(c('2022-02-17', '2022-02-22', '2022-03-04', '2022-03-18', '2022-04-18', '2022-06-20', '2022-08-26', '2022-11-18', '2023-02-20', '2023-06-05', '2023-09-11', '2024-02-19', '2025-02-24')),
  weight_lb = c(6, 6, 6, 9, 11, 14, 17, 18, 19, 20, 22, 24, 27),
  weight_oz = c(13, 10, 12.5, 1.6, 10.5, 11.5, 13.5, 9.5, 6, 8, 11.2, 0, 12.8)
) %>% 
  mutate(
...
lendat <- data.frame(
    date = ymd(c('2022-02-17', '2022-03-04', '2022-04-18', '2022-06-20', '2022-08-26', '2022-11-18', '2023-02-20', '2023-06-05', '2023-09-11', '2024-02-19', '2025-02-24')),
    length_in = c(19.8, 20, 22.7, 25, 28.5, 29.2, 30.7, 31.7, 32.6, 34, 38)
  ) %>% 
  mutate(
    months = as.numeric((date - min(date)) / 31),
